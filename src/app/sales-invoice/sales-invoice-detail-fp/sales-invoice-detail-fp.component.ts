...
@Component({
  selector: 'app-sales-invoice-detail-fp',
  templateUrl: './sales-invoice-detail-fp.component.html',
  styleUrls: ['./sales-invoice-detail-fp.component.css']
})
export class SalesInvoiceDetailFpComponent implements OnInit {
